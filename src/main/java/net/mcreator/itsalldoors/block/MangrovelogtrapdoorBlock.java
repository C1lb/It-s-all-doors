...
public class MangrovelogtrapdoorBlock extends TrapDoorBlock {
	...
	public MangrovelogtrapdoorBlock() {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(ItsAllDoorsModBlocks.MANGROVELOGTRAPDOOR, RenderType.cutoutMipped());
	}
}
